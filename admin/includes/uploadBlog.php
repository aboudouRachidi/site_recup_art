<?php /* non utiliser pour le monment
include("coBDD.php");
session_start();
$target_dir = "../blog/";
...
if(isset($_POST["nameFile"])&&isset($_POST["texte"])){
...
// Si tout est ok, on essaye de télécharger l'image
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
        ...
        $url="blog/".$_FILES["fileToUpload"]["name"];
        $ajoutImage=$db->query("INSERT INTO `recup_art`.`blog` VALUES (NULL,'".$nomFile."','".$date."','".$texte."',
        		'".$url."','".$url_video."')");
